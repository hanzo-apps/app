...
const socials = [
  {
    ...
    href: 'https://twitter.com/hanzodotai',
  },
  {
    icon: (
...
const menus = [
  ...
  },
  {
    ...
    child: [
      {
        menu: 'Github',
        path: 'https://github.com/hanzoai/hanzo',
        external: true,
      },
      {
        menu: 'Discord',
      ...
      {
        menu: 'Twitter',
        path: 'https://twitter.com/hanzodotai',
        external: true,
      },
      {
        menu: 'LinkedIn',
        path: 'https://www.linkedin.com/company/hanzoai',
        external: true,
      },
    ],
  },
  {
    ...
    child: [
      ...
      {
        menu: 'Careers',
        path: 'https://hanzoai.bamboohr.com/careers',
        external: true,
      },
    ],
  },
...
export default function Footer() {
  ...
  const onSubmit = (data: { email: string }) => {
    ...
    if (email) {
      fetch('https://brevo.hanzo.ai/', options)
    ...
    <div className="flex-shrink-0 relative overflow-hidden w-full">
        ...
        <div className="col-span-2">
          ...
          <div className="w-full lg:w-3/4 mt-2">
            ...
            <p className="dark:text-gray-400 text-gray-600 mt-2">
              ...
              research and building Hanzo AI:
            </p>
      ...
      <div className="mt-10">
        <div className="flex w-full justify-between items-center flex-col md:flex-row gap-4">
          ...
          <span>&copy;{getCurrentYear}&nbsp;Hanzo AI</span>
          <ThemeImage
            source={{
              light: '/assets/images/general/hanzoai.svg',
              dark: '/assets/images/general/hanzoai.svg',
            }}
            alt="App screenshots"
            width={80}
            height={200}
