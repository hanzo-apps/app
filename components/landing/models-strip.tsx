      ...
      <YStack alignSelf="center" width="100%" maxWidth={1152} alignItems="center" gap="$8" $lg={{ gap: "$10" }} className="shrink-cells">
        <Reveal>
          ...
          <Paragraph marginTop="$4" maxWidth={448} fontSize="$4" color="$color11" $md={{ fontSize: "$6" }} lineHeight="1.5">
            ...
            alongside Anthropic, OpenAI, Google and Mistral — through OpenAI-
            and Anthropic-compatible endpoints. Change the model by changing one
            string. Connect MCP tool servers and Hanzo AI calls them
            mid-completion.
          </Paragraph>
