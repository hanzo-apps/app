    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent maxWidth={768} maxHeight="90vh">
        ...
        <YStack rowGap="$5" maxHeight="60vh" paddingRight="$4" overflow="scroll">
          <section>
            <YStack rowGap="$3">
              <SizableText fontSize="$3" color="$color11" lineHeight="1.625">
                Hanzo App is an app builder that runs in the browser. Describe what you want and an agent writes the code, commits it to git, builds it, and puts it on a URL at your-app.hanzo.app. Web apps and games, on Hanzo Cloud.
              </SizableText>

              <SizableText fontSize="$3" color="$color11" lineHeight="1.625">
                Every app gets a database, sign-in through hanzo.id, AI through api.hanzo.ai, and file storage, all connected the first time it runs. Usage and billing are the same account across every Hanzo surface. Import a repo and keep building from code you already have.
              </SizableText>

              <SizableText fontSize="$3" color="$color11" lineHeight="1.625">
                If you build something with it, share it in the community gallery so other people can fork it.
              </SizableText>
            </YStack>
          </section>

          <section>
            <H3 fontWeight="500" fontSize="$6" marginBottom="$3">Links</H3>
            <YStack gap="$2">
              ...
              <Anchor display="inline-flex"
                ...
                alignItems="center" gap="$2" fontSize="$3" color="$blue10" $theme-dark={{ color: "$blue8" }} hoverStyle={{ textDecorationLine: "underline" }}
              >
                <svg fill="currentColor" fillRule="evenodd" style={{ flex: "none", lineHeight: "1" }} viewBox="0 0 24 24" width={16} height={16} xmlns="http://www.w3.org/2000/svg">
