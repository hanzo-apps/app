  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: 'Functions',
        icon: FunctionSquare,
        blurb: 'Serverless functions this workspace has deployed, and how often they run.',
      },
      {
        id: 'cloud-sandboxes',
        label: 'Sandboxes',
        icon: Box,
        blurb: 'The boxes your builds run in — what is up, and what it belongs to.',
      },
      {
        id: 'cloud-agents',
        label: 'Agents',
        icon: Boxes,
        blurb: 'Agents this workspace can run, and how often each has run.',
      },
      {
        id: 'cloud-bots',
        label: 'Bots',
        icon: Bot,
        blurb: 'Bots this workspace has published.',
      },
      {
        id: 'cloud-logs',
        label: 'Logs',
