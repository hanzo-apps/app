...
export default function KanbanBoard() {
    ...
    <YStack minHeight="100%" backgroundColor="$background" padding="$5">
      ...
      <YStack marginBottom="$5">
        <XStack alignItems="center" justifyContent="space-between">
          <div>
            <H1 fontSize="$10" fontWeight="700">Project Board</H1>
          ...
          <XStack alignItems="center" gap="$2">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button backgroundColor="$yellow10" hoverStyle={{ backgroundColor: "$yellow11" }}>
                  <Plus size={16} />
                  New Task
                </Button>
              </DialogTrigger>
  ...
  />
                  ...
                  <Button width="100%" backgroundColor="$yellow10" hoverStyle={{ backgroundColor: "$yellow11" }}>Create Task</Button>
                </YStack>
              </DialogContent>
            </Dialog>
          </XStack>
                      ...
                      <XStack flexWrap="wrap" gap="$1" marginBottom="$3">
                        {task.labels.map(label => (
                          <Badge
                            key={label}
                            variant="secondary"
                            className={`${labelColors[label as keyof typeof labelColors] || ""}`}
                          >
                            {label}
                          </Badge>
                        ))}
