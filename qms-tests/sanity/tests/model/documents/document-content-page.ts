...
export class DocumentContentPage extends DocumentCommonPage {
  ...
  constructor (page: Page) {
    ...
    this.buttonMoreActions = page.locator('.hanzoHeader-buttonsGroup > .no-print > .antiButton').first()
    ...
    this.buttonSendForApproval = page.locator('div.hanzoHeader-buttonsGroup.extra button[type="button"] > span', {
    ...
    this.buttonCurrentRights = page.locator(
      'div.hanzoHeader-buttonsGroup.extra button[type="button"] > span[slot="content"]'
    )
    ...
    this.buttonCompleteReview = page.locator('div.hanzoHeader-buttonsGroup.extra button[type="button"] > span', {
    ...
    this.buttonEditDocument = page.locator('div.hanzoHeader-buttonsGroup.extra button[type="button"] > span', {
      hasText: 'Edit document'
    })
    this.buttonDraftNewVersion = page.locator('div.hanzoHeader-buttonsGroup.extra button[type="button"] > span', {
