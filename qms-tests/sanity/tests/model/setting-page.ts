...
export class SettingsPage {
  ...
  constructor (page: Page) {
    ...
    this.addPermissionButton = page.locator('.hanzoTableAttr-header > .font-medium-14')
    ...
    this.addUpdateDocumentOwnerPermission = page.locator('.hanzoTableAttr-header > .font-medium-14')
  }
