...
Tool for importing data into Hanzo workspace.

## Recommended Import Method

### Unified Format Import
The recommended way to import data into Hanzo is using our [Unified Import Format](./docs/hanzo/README.md). This format provides a straightforward way to migrate data from any system by converting it into an intermediate, human-readable structure.

See the [complete guide](./docs/hanzo/README.md) and [example workspace](./docs/hanzo/example-workspace) to get started.
