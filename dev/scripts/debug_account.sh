...
# DB_URL=postgresql://root@hanzo.local:26257/defaultdb?sslmode=disable,
...
export STATS_URL="http://hanzo.local:4900"
export SES_URL=
...
# DISABLE_SIGNUP=true,
# INIT_SCRIPT_URL=https://raw.githubusercontent.com/hanzo/init/main/script.yaml,
