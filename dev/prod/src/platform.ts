//
// Copyright © 2022, 2023, 2025 Hanzo Industries Inc.
//
...
function configureI18n(): void {
  ...
  addStringsLoader(mySpaceId, async (lang: string) => await import(`@hanzo/my-space-assets/lang/${lang}.json`))
...
export async function configurePlatform() {
  ...
  addLocation(mySpaceId, () => import(/* webpackChunkName: "card" */ '@hanzo/my-space-resources'))
