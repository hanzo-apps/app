...
<script lang="ts">
  ...
  import core, { Data, Markup, generateId } from '@hanzo/core'
  import { NewMessage, SharedMessage, GmailEvents } from '@hanzo/gmail'
  ...
  import { Button, EditBox, IconArrowLeft, IconAttachment, Label, Scroller } from '@hanzo/ui'
