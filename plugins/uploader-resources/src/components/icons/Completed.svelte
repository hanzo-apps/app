...
<svg class="svg-{size}" {fill} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  ...
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
    d="M22.7071 11.2931C23.0976 11.6837 23.0976 12.3168 22.7071 12.7074L14.7071 20.7074C14.3166 21.0979 13.6834 21.0979 13.2929 20.7074L9.29289 16.7074C8.90237 16.3168 8.90237 15.6837 9.29289 15.2931C9.68342 14.9026 10.3166 14.9026 10.7071 15.2931L14 18.586L21.2929 11.2931C21.6834 10.9026 22.3166 10.9026 22.7071 11.2931Z"
  />
</svg>
