...
import core, { type Class, type Client, type Doc, type Ref } from '@hanzo/core'
import time from '@hanzo/time'
import { type TextEditorMode, type AnyExtension } from '@hanzo/text-editor'
import { SvelteNodeViewRenderer } from '@hanzo/text-editor-resources'
