...
<script lang="ts">
  ...
  import { IssueTemplate, IssueTemplateChild, Project } from '@hanzo/tracker'
  import { Button, EditBox, IconMoreH, Label, getCurrentResolvedLocation, navigate } from '@hanzo/ui'
