...
test.describe('Sol Functionality Tests', () => {
  ...
  test('1. Apps load and show up in search', async () => {
    ...
    await window.screenshot({ 
      path: 'test-results/sol/01-app-search.png',
      fullPage: true 
    });
  ...
  test('2. Icons appear for apps', async () => {
    ...
    await window.screenshot({ 
      path: 'test-results/sol/02-app-icons.png',
      fullPage: true 
    });
  ...
  test('3. Running apps are detected', async () => {
    ...
    // Take screenshot
    await window.screenshot({ 
      path: 'test-results/sol/03-running-apps.png',
      fullPage: true 
    });
  });
  ...
  test('4. Apps can be launched', async () => {
    ...
    await window.screenshot({ 
      path: 'test-results/sol/04-before-launch.png',
      fullPage: true 
    });
  ...
  test('5. Search functionality works correctly', async () => {
    ...
    await window.screenshot({ 
      path: 'test-results/sol/05-search-results.png',
      fullPage: true 
    });
...
test.beforeAll(async () => {
  ...
  const resultsDir = path.join(process.cwd(), 'test-results', 'sol');
