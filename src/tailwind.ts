...
export const accentRgb = hexToRgb(hanzoNative.accentColor)

// config.theme.extend.colors.accent = hanzoNative.accentColor
// const accentRbg = hexToRgb(hanzoNative.accentColor)
