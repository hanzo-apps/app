...
export const dataProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'Columnar analytics database for real-time queries on massive datasets. OLAP at scale.',
    category: 'data',
    icon: 'BarChart3',
  ...
  },
  {
    ...
    tagline: 'Vector search in Hanzo Datastore',
...
export const mlProducts: Product[] = [
  ...
  },
  {
    ...
    name: 'Zen Models',
    shortName: 'Zen',
    tagline: 'AI model lineup from edge to frontier',
    description: 'Zen4 (dense and MoE) and Zen3 (multimodal, vision, safety, embeddings) with OpenAI-compatible API.',
    category: 'ml',
    subcategory: 'Models',
    icon: 'Sparkles',
    ...
    features: ['Zen4 Flagship (~400B dense)', 'Zen4 Coder (480B MoE, 262K ctx)', 'Zen4 Thinking (MoE+CoT)', 'Zen3 Omni (multimodal)', 'Zen3 VL (vision-language)', 'Zen3 Guard (safety)', 'Zen3 Embedding', 'OpenAI-compatible API'],
    status: 'ga',
    openSource: true,
    pricing: 'freemium'
  },
...
export const growthProducts: Product[] = [
  {
    ...
    description: 'Understand user behavior with product analytics. Event tracking, funnels, cohorts, session replay, and feature flags. analytics-compatible.',
    category: 'growth',
    icon: 'PieChart',
