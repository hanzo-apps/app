...
// Run after changing lib/gui.config.ts:  node scripts/gen-gui-css.mjs
...
execSync('npx esbuild lib/gui.config.ts --bundle --format=esm --platform=node --external:react --external:react-dom --external:react-native --alias:react-native=react-native-web --outfile=.guicfg.gen.mjs --log-level=error', { stdio: 'inherit' })
