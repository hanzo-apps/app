          ...
          {metrics.map((metric) => (
            <Card key={metric.title}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <div className="w-8 h-8 rounded-full bg-[#171717]/10 flex items-center justify-center text-[#171717]">
                  {metric.icon}
                </div>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-4">
                    {recentSales.map((sale, i) => (
                      <div key={i} className="flex items-center">
                        <div className="w-9 h-9 rounded-full bg-[#171717]/10 flex items-center justify-center text-sm font-medium text-[#171717]">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <Progress value={32} className="h-2 [&>div]:bg-[#171717]" />
