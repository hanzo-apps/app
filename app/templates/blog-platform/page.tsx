...
const featuredArticle = {
  ...
  coverImage: "/v1/placeholder/1200/600",
...
const articles = [
  {
    ...
    author: { name: "Alex Rivera", avatar: "/v1/placeholder/40/40" },
    coverImage: "/v1/placeholder/400/300",
    readTime: "8 min",
  ...
  },
  {
    ...
    author: { name: "Jordan Park", avatar: "/v1/placeholder/40/40" },
    coverImage: "/v1/placeholder/400/300",
    readTime: "6 min",
  ...
  },
  {
    ...
    author: { name: "Morgan Lee", avatar: "/v1/placeholder/40/40" },
    coverImage: "/v1/placeholder/400/300",
    readTime: "10 min",
...
export default function BlogPlatform() {
  ...
  />
                      ...
                      <YStack padding="$4">
                        ...
                        <H3 fontWeight="500" fontSize="$6" marginBottom="$2">{article.title}</H3>
