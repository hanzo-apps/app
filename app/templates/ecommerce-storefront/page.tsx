...
export default function EcommerceStorefront() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-[#171717] to-[#404040] text-white py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-[#171717]/10 flex items-center justify-center mx-auto mb-3">
                <ShoppingCart className="w-6 h-6 text-[#171717]" />
              </div>
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-[#404040]/10 flex items-center justify-center mx-auto mb-3">
                <Star className="w-6 h-6 text-[#404040]" />
              </div>
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-[#171717]/10 flex items-center justify-center mx-auto mb-3">
                <Heart className="w-6 h-6 text-[#171717]" />
              </div>
