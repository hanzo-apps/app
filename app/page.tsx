      ...
      <main className="relative z-10">
        ...
        <section className="px-4 md:px-8 pt-16 md:pt-24 pb-20 md:pb-32">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-6 md:mb-8 bg-[#171717]/10 border border-[#171717]/20 rounded-full">
        ...
        <section className="px-4 md:px-8 py-16 md:py-20 bg-gradient-to-b from-transparent via-[#171717]/10 to-transparent">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              <Badge className="mb-4 bg-gradient-to-r from-[#171717] to-[#000000] text-white border-0 px-3 md:px-4 py-1.5">
                  ...
                  <div className="bg-[#1a1a1a] rounded-xl md:rounded-2xl overflow-hidden border border-white/10 hover:border-[#171717]/50 transition-all duration-300 hover:shadow-2xl hover:shadow-[#171717]/10 hover:-translate-y-1">
                    ...
                    <div className="p-4 md:p-5">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-5 md:w-6 h-5 md:h-6 rounded-full bg-gradient-to-br from-[#171717] to-[#404040] flex items-center justify-center">
            ...
            <div className="text-center mt-8 md:mt-12 space-y-4">
              ...
              <div className="flex items-center justify-center gap-4">
                <Button
                  ...
                  className="bg-gradient-to-r from-[#171717] to-[#000000] text-white hover:from-[#000000] hover:to-[#171717]"
                >
                ...
                {projects.slice(0, 4).map((project) => (
                  ...
                  >
                    <div className="bg-[#1a1a1a] rounded-xl md:rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all hover:shadow-xl">
                      <div className="aspect-video bg-gradient-to-br from-[#171717]/20 to-[#404040]/20 relative">
