...
export class ApplicationsPage extends CommonRecruitingPage {
  ...
  readonly buttonTypeSelector = (): Locator =>
    this.page.locator('div[class*="hanzoHeader-container"] div[class*="hanzoHeader-titleGroup"] button')
  ...
  async openApplicationByTalentName (talentName: TalentName): Promise<void> {
    await this.page
      ...
      .click()
    await expect(
      this.page.locator('div.hanzoHeader-container div.hanzoHeader-titleGroup', { hasText: talentName.lastName })
