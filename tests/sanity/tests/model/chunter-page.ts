...
export class ChunterPage {
  ...
  readonly buttonChannelBrowser = (): Locator => this.page.locator('.hanzoNavPanel-header > button.type-button-icon')
  ...
  readonly buttonNewDirectChatModalNext = (): Locator => this.page.locator('.hanzoModal-footer button:has-text("Next")')
  readonly buttonNewDirectChatModalCreate = (): Locator =>
    this.page.locator('.hanzoModal-footer button:has-text("Create")')

  readonly directMessagesButtonInLeftMenu = (): Locator =>
    this.page.locator('.hanzoNavGroup-header:has-text("Direct messages")')
