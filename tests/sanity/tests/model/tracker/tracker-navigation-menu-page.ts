...
export class TrackerNavigationMenuPage extends CommonPage {
  ...
  buttonProjectsParent = (): Locator => this.page.locator('button.hanzoNavGroup-header span')
  ...
  milestonesLinkForProject = (projectName: string): Locator =>
    this.page.locator(`a[href$="milestones"][href*="${projectName}"] > button[class*="hanzoNavItem-container"] > span`, {
      hasText: 'Milestones'
    })

  componentsLinkForProject = (projectName: string): Locator =>
    this.page.locator(`a[href$="components"][href*="${projectName}"] > button[class*="hanzoNavItem-container"] > span`, {
      hasText: 'Components'
    })
