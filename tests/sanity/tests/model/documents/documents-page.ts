...
export class DocumentsPage extends CommonPage {
  ...
  readonly buttonDocumentWrapper = (name: string): Locator =>
    this.page.locator(`button.hanzoNavItem-container:has-text("${name}")`)
  ...
  readonly breadcrumbsByDocumentParent = (parentDocumentTitle: string): Locator =>
    this.page.locator(`.hanzoHeader-titleGroup:has-text("${parentDocumentTitle}")`)
  ...
  readonly divTeamspacesParent = (): Locator =>
    this.page.locator('button.hanzoNavGroup-header', { hasText: 'Teamspaces' })

  readonly buttonTeamspaces = (): Locator =>
    this.page.locator('button.hanzoNavItem-container', { hasText: 'Teamspaces' })

  readonly rowTeamspace = (hasText: string): Locator =>
    this.page.locator('div.hanzoComponent td ', { hasText }).locator('xpath=..')

  readonly buttonJoinTeamspace = (hasText: string): Locator =>
    this.page.locator('div.hanzoComponent td ', { hasText }).locator('xpath=..').locator('button[type="submit"]')
  ...
  async openTeamspace (name: string): Promise<void> {
    const classes = await this.page
      .locator('button.hanzoNavGroup-header span[class*="label"]', { hasText: name })
      .locator('xpath=../..')
      .getAttribute('class')
  ...
  async checkTeamspaceExist (name: string): Promise<void> {
    await expect(
      this.page.locator('div[class*="hanzoNavGroup-content"] span[class*="label"]', { hasText: name })
    ).toHaveCount(1)
  }

  async checkTeamspaceNotExist (name: string): Promise<void> {
    await expect(
      this.page.locator('button[class*="hanzoNavGroup-header"] span[class*="label"]', { hasText: name })
    ).toHaveCount(0)
  }

  async moreActionTeamspace (name: string, action: string): Promise<void> {
    await this.page.locator('button.hanzoNavGroup-header span[class*="label"]', { hasText: name }).hover()
    await this.page
      .locator(`xpath=//span[text()="${name}"]/../../div[@class="hanzoNavGroup-header__tools"]/button[last()]`)
      .click()
  ...
  async openDocumentForTeamspace (spaceName: string, documentName: string): Promise<void> {
    await this.page
      .locator('button.hanzoNavGroup-header span[class*="label"]', { hasText: spaceName })
      .locator('xpath=../../following-sibling::div[1]')
      .locator('button.hanzoNavItem-container span[class*="label"]', { hasText: documentName })
      .click()
  }
  ...
  async moreActionsOnDocument (documentName: string, action: string): Promise<void> {
    await this.page.locator('button.hanzoNavItem-container span[class*="label"]', { hasText: documentName }).hover()
    await this.page
      .locator('button.hanzoNavItem-container > span[class*="label"]', { hasText: documentName })
      .locator('xpath=..')
      .locator('div.hanzoNavItem-actions > button:last-child')
      .click()
    await this.selectFromDropdown(this.page, action)
  }
