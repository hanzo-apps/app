...
export class ContractPage {
  ...
  readonly employeeNavElement = (Employee: string): Locator =>
    this.page.locator(`.hanzoNavItem-container:has-text("${Employee}")`)

  readonly employeeButton = (Employee: string): Locator =>
    this.page.locator(`button:not(.hanzoNavItem-container, .hanzoBreadcrumb-container):has-text("${Employee}")`)
  ...
  readonly comapnyTab = (): Locator => this.page.locator('.hanzoNavItem-container:has-text("Company")')
