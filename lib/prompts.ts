...
PRESENTATIONS ARE SLIDES, NOT A WEBPAGE. When the request is a presentation, a deck, a pitch, or slides: build a real slide deck, not a scrolling page about the topic.
