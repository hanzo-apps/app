...
import mySpace, { mySpaceId, createModel as mySpaceModel } from '@hanzo/model-my-space'
...
import { serverFulltextId, createModel as serverFulltextModel } from '@hanzo/model-server-fulltext'
